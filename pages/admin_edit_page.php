                ...
                <div class="x_panel" style="display:block;margin:auto;margin-top:100px;margin-bottom:100px;">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <?php 
                            $user = mysqli_fetch_object(mysqli_query($conn, "SELECT * FROM admin_users WHERE id = '$_GET[id]'"));
                            ?>
                            <form action="../php/edit_admin.php?id=<?php echo $_GET['id'] ?>" method="POST" class="form-horizontal form-label-left" novalidate enctype="multipart/form-data">

                                <span class="section">Edit Admin</span>

                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">First name<span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" data-validate-length-range="3" name="fname" value="<?php echo $user->fname ?>" required="required" type="text">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" data-validate-length-range="3" name="mname" value="<?php echo $user->mname ?>" required="required" type="text">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" data-validate-length-range="3" name="lname" value="<?php echo $user->lname ?>" required="required" type="text">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" data-validate-length-range="3" name="email" value="<?php echo $user->email ?>" required="required" type="email">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" data-validate-length-range="11" name="contact_number" value="<?php echo $user->contact_number ?>" required="required" type="tel">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" data-validate-length-range="3" name="uname" id="uname" value="<?php echo $user->uname ?>" required="required" type="text" onBlur="checkAvailability()">
                                    </div>
                                </div>
